...
class Facebook
{
     ...
     * The cookie is not set by the Facebook class, but
     ...
     * metadata. The cookie is not set by the Facebook class, but it may be
    ...
    {
        $name = 'api';
        if (isset(self::$READ_ONLY_CALLS[strtolower($method)])) {
            $name = 'api_read';
